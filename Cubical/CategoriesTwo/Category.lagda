...
CatIsoIdenAux : {ℓ ℓ' : Level} (𝓒 : PreCategory ℓ ℓ') (x y : 𝒪𝒷 ⟪ 𝓒 ⟫) (h h' : 𝒽 ⟪ 𝓒 ⟫ x y)
             (h⁻¹ h'⁻¹ : 𝒽 ⟪ 𝓒 ⟫ y x) → h ≡ h' → 𝑆⟦ 𝓒 ⟧ h h⁻¹ ≡ 𝒾𝒹⟦ 𝓒 ⟧ x
          → 𝑆⟦ 𝓒 ⟧ h⁻¹ h ≡ 𝒾𝒹⟦ 𝓒 ⟧ y → 𝑆⟦ 𝓒 ⟧ h' h'⁻¹ ≡ 𝒾𝒹⟦ 𝓒 ⟧ x
          → 𝑆⟦ 𝓒 ⟧ h'⁻¹ h' ≡ 𝒾𝒹⟦ 𝓒 ⟧ y → h⁻¹ ≡ h'⁻¹
CatIsoIdenAux 𝓒 a r h h' h⁻¹ h'⁻¹ h≡h' h∘h⁻¹≡𝒾𝒹ₐ h⁻¹∘h≡𝒾𝒹ᵣ h'∘h'⁻¹≡𝒾𝒹ₐ h'⁻¹∘h'≡𝒾𝒹ᵣ =
 h⁻¹ ≡⟨ sym (𝑆-ρ⟦ 𝓒 ⟧ h⁻¹) ⟩
 𝑆⟦ 𝓒 ⟧ h⁻¹ (𝒾𝒹⟦ 𝓒 ⟧ a) ≡⟨ cong (𝑆⟦ 𝓒 ⟧ h⁻¹) (sym h'∘h'⁻¹≡𝒾𝒹ₐ) ⟩
 𝑆⟦ 𝓒 ⟧ h⁻¹ (𝑆⟦ 𝓒 ⟧ h' h'⁻¹) ≡⟨ sym (𝑆-α⟦ 𝓒 ⟧ h⁻¹ h' h'⁻¹) ⟩
 𝑆⟦ 𝓒 ⟧ (𝑆⟦ 𝓒 ⟧ h⁻¹ h') h'⁻¹ ≡⟨ cong (λ - → 𝑆⟦ 𝓒 ⟧ (𝑆⟦ 𝓒 ⟧ h⁻¹ -) h'⁻¹) (sym h≡h') ⟩
 𝑆⟦ 𝓒 ⟧ (𝑆⟦ 𝓒 ⟧ h⁻¹ h) h'⁻¹ ≡⟨ cong (λ - → 𝑆⟦ 𝓒 ⟧ - h'⁻¹) h⁻¹∘h≡𝒾𝒹ᵣ ⟩
 𝑆⟦ 𝓒 ⟧ (𝒾𝒹⟦ 𝓒 ⟧ r) h'⁻¹ ≡⟨ 𝑆-λ⟦ 𝓒 ⟧ h'⁻¹ ⟩
 h'⁻¹ ∎

CatIsoIden : {ℓ ℓ' : Level} (𝓒 : PreCategory ℓ ℓ') (x y : 𝒪𝒷 ⟪ 𝓒 ⟫) (γ δ : CatIso ⟪ 𝓒 ⟫ x y)
          → fst γ ≡ fst δ → γ ≡ δ
CatIsoIden 𝓒 x y (γ , γ⁻¹ , γp , γq) (δ , δ⁻¹ , δp , δq) p =
